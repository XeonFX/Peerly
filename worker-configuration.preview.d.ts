/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.preview.jsonc --env-interface=PreviewEnv worker-configuration.preview.d.ts` (hash: 8bc9b3d6e7024f5ba8761c5707947f4a)
...
interface __BaseEnv_PreviewEnv {
	...
	TURN_URLS: "turn:turn.peerly.cc:3478,turns:turn.peerly.cc:5349";
	...
	WORKSPACES: DurableObjectNamespace<import("./worker/index").WorkspaceDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "UserGatewayDO" | "SignalScopeDO" | "WorkspaceDO";
	}
