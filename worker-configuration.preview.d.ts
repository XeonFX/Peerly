/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.preview.jsonc --env-interface=PreviewEnv worker-configuration.preview.d.ts` (hash: e2fe67b4335e597bd78a0a674cef62cf)
