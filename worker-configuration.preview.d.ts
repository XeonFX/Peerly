/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.preview.jsonc --env-interface=PreviewEnv worker-configuration.preview.d.ts` (hash: 395d1ad854a77c7ff059e0b851fbce4e)
// Runtime types generated with workerd@1.20260921.1 2026-07-22 
interface __BaseEnv_PreviewEnv {
	...
	NETWORK_SESSION_SECRET: string;
	OPAQUE_USER_ID_SECRET: string;
	USER_GATEWAYS: DurableObjectNamespace<import("./worker/index").UserGatewayDO>;
	SIGNAL_SCOPES: DurableObjectNamespace<import("./worker/index").SignalScopeDO>;
	CONTENT_CHANNELS: DurableObjectNamespace<import("./worker/index").ContentChannelDO>;
	LOBBY_CHANNELS: DurableObjectNamespace<import("./worker/index").LobbyChannelDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "UserGatewayDO" | "SignalScopeDO" | "ContentChannelDO" | "LobbyChannelDO";
	}
