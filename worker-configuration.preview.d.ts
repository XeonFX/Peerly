/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.preview.jsonc --env-interface=PreviewEnv worker-configuration.preview.d.ts` (hash: 9b429b0c23b586390e43d8af1304d6ea)
