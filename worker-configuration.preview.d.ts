/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.preview.jsonc --env-interface=PreviewEnv worker-configuration.preview.d.ts` (hash: 9a739d0f6eb38047992adac12010d7e8)
