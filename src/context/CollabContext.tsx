...
export function CollabProvider({
  ...
  const chat = useMemo<ChatSlice>(
    () => ({
      ...
      pendingMessages: collab.pendingMessages,
      cancelPendingMessage: collab.cancelPendingMessage,
      retryPendingMessages: collab.retryPendingMessages,
      draftScope: collab.draftScope,
    ...
    [
      ...
      collab.totalUnread,
      collab.sendMessage,
      collab.pendingMessages,
      collab.retryPendingMessages,
      collab.cancelPendingMessage,
      collab.draftScope,
      collab.editMessage,
