...
const plByEnglish: Record<string, string> = {
  ...
  'Browser notifications announce direct messages and friend requests while Peerly is in the background.': 'Powiadomienia przeglądarki informują o wiadomościach bezpośrednich i zaproszeniach do znajomych, gdy Peerly działa w tle.',
  'Turn on notifications': 'Włącz powiadomienia',
  'Turn off notifications': 'Wyłącz powiadomienia',
  Account: 'Konto',
  'Sync activity': 'Aktywność synchronizacji',
  'Approved device': 'Zatwierdzone urządzenie',
  'Nearby user (not a friend)': 'Użytkownik w pobliżu (nieznajomy)',
  'Workspace member': 'Członek przestrzeni',
  'Unknown peer': 'Nieznany peer',
  'Metadata about recent peer-to-peer transfers. Message contents, room secrets, and private keys are never shown here.': 'Metadane ostatnich transferów peer-to-peer. Treść wiadomości, sekrety pokojów i klucze prywatne nigdy nie są tutaj wyświetlane.',
  'No P2P transfers recorded in this session yet.': 'Nie zarejestrowano jeszcze transferów P2P w tej sesji.',
  'Sent to': 'Wysłano do',
  'Received from': 'Odebrano od',
  Peer: 'Peer',
  items: 'elementów',
  ...
  'Approved devices': 'Zatwierdzone urządzenia',
  'This device': 'To urządzenie',
  'No other devices are approved yet.': 'Nie zatwierdzono jeszcze innych urządzeń.',
  'Last seen': 'Ostatnio widziane:',
  'Revoke': 'Cofnij dostęp',
  'Revoke this device? It will stop syncing with this device.': 'Cofnąć dostęp temu urządzeniu? Synchronizacja z nim zostanie zatrzymana.',
  'Approve another device': 'Zatwierdź inne urządzenie',
  'Open this private link on your other device:': 'Otwórz ten prywatny link na drugim urządzeniu:',
  'Waiting for the other device…': 'Oczekiwanie na drugie urządzenie…',
  'Confirm that this fingerprint matches the other device:': 'Potwierdź, że ten odcisk odpowiada drugiemu urządzeniu:',
  'Approve device': 'Zatwierdź urządzenie',
  'Approved here. Confirm on the other device too.': 'Zatwierdzono tutaj. Potwierdź również na drugim urządzeniu.',
  'Approved. Syncing data…': 'Zatwierdzono. Synchronizowanie danych…',
  'Device approved and sync enabled.': 'Urządzenie zatwierdzone, synchronizacja włączona.',
  'Pair only devices you control. Approval is mutual and the pairing link is a one-time secret.': 'Paruj tylko własne urządzenia. Zatwierdzenie jest wzajemne, a link parowania jest jednorazowym sekretem.',
  'Approve another device to sync your Peerly data and manage your messages from either device while both are online.': 'Zatwierdź inne urządzenie, aby synchronizować dane Peerly i zarządzać wiadomościami z obu urządzeń, gdy są online.',
  ...
  'This friend uses the old insecure DM format. Remove and invite them again to create a secure credential.':
    'Ten znajomy używa starego, niezabezpieczonego formatu. Usuń go i zaproś ponownie, aby utworzyć bezpieczne dane dostępu.',
  ...
  'started an audio call.': 'rozpoczął(-ęła) rozmowę audio.',
  Join: 'Dołącz',
  Dismiss: 'Odrzuć',
  'Start video call': 'Rozpocznij rozmowę wideo',
  'Start audio call': 'Rozpocznij rozmowę audio',
